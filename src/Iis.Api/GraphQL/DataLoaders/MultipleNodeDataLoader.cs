...
{
    public class MultipleNodeDataLoader : DataLoaderBase<Tuple<Guid, IEnumerable<EmbeddingRelationType>>, Node>
    {
        ...
        protected override async Task<IReadOnlyList<Result<Node>>> FetchAsync(IReadOnlyList<Tuple<Guid, IEnumerable<EmbeddingRelationType>>> keys, CancellationToken cancellationToken)
        {

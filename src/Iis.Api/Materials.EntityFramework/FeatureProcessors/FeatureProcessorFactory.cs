...
namespace IIS.Core.Materials.EntityFramework.FeatureProcessors
{
    public class FeatureProcessorFactory : IFeatureProcessorFactory
    {
        ...
        public FeatureProcessorFactory(IElasticService elasticService, IOntologyModel ontology, MutationCreateResolver createResolver, MutationUpdateResolver updateResolver, IElasticState elasticState)
        {
        ...
        public IFeatureProcessor GetInstance(string materialSource, string materialType)
        {
            ...
            {
                "cell.voice" when materialType == "audio" => new CellVoiceFeatureProcessor(_elasticService, _ontology, _createResolver, _updateResolver, _elasticState),

...
namespace Iis.Interfaces.Elastic
{
    ...
    {
        private static readonly SearchEntitiesByConfiguredFieldsResult _emprtyResult;

        static SearchEntitiesByConfiguredFieldsResult()
        {
            _emprtyResult = new SearchEntitiesByConfiguredFieldsResult
            {
                Count = 0,
        ...
        public static SearchEntitiesByConfiguredFieldsResult Empty => _emprtyResult;
    }
}

...
namespace Iis.Interfaces.Elastic
{
    public interface IElasticManager
    {
        ...
        Task<IElasticSearchResult> SearchMoreLikeThisAsync(IIisElasticSearchParams searchParams, CancellationToken cancellationToken = default);
        ...
        Task<List<ElasticBulkResponse>> PutsDocumentsAsync(string indexName, string materialDocuments, CancellationToken token);

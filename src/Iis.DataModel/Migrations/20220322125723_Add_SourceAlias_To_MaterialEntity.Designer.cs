...
namespace IIS.Core.Migrations
{
    ...
    [Migration("20220322125723_Add_SourceAlias_To_MaterialEntity")]
    partial class Add_SourceAlias_To_MaterialEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iis.DataModel.Materials.MaterialAssigneeEntity", b =>
                {
                    ...
                    b.HasKey("MaterialId", "AssigneeId");

                    b.HasIndex("AssigneeId");

                    b.ToTable("MaterialAssignees");
                });

            modelBuilder.Entity("Iis.DataModel.Materials.MaterialChannelMappingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MaterialChannelMappings");
                });
            ...
            modelBuilder.Entity("Iis.DataModel.Materials.MaterialSecurityLevelEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("SecurityLevelIndex")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MaterialSecurityLevels");
                });
            ...
            modelBuilder.Entity("Iis.DataModel.NodeTypeEntity", b =>
                {
                    ...
                    b.Property<bool>("IsHierarchyParent")
                        .HasColumnType("boolean");
                    ...
                    b.Property<int>("SecurityStrategy")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Iis.DataModel.Roles.AccessObjectEntity", b =>
                {
                    ...
                    b.Property<bool>("AccessLevelUpdateAllowed")
                        .HasColumnType("boolean");

                    b.Property<int>("Category")
                        .HasColumnType("integer");

                    b.Property<bool>("CommentingAllowed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Iis.DataModel.Roles.RoleAccessEntity", b =>
                {
                    ...
                    b.Property<bool>("AccessLevelUpdateGranted")
                        .HasColumnType("boolean");

                    b.Property<Guid>("AccessObjectId")
                        .HasColumnType("uuid");

                    b.Property<bool>("CommentingGranted")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Iis.DataModel.UserSecurityLevelEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

...
namespace Iis.DbLayer.Repositories
{
    public interface IUserRepository
    {
        ...
        Task<UserEntity[]> GetUsersAsync(int skip, int take, string sortColumn, ListSortDirection? sortDirection, Expression<Func<UserEntity, bool>> predicate = null, Guid? roleId = null, CancellationToken cancellationToken = default);

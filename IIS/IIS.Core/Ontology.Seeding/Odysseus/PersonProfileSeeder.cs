    ...
    public partial class TypeSeeder
    {
        private void CreatePersonProfile(OntologyBuildContext ctx, ITypeBuilder profile)
        {
            ...
            profile
                ...
                .HasOptional(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("HighRiskPositionAudit")
                        ...
                        .HasOptional("Attachment", "AuditRequest", "Заява на перевірку")
                ...
                .HasMultiple(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("UnprocessedDocsLetter")
                        ...
                        .HasOptional("Attachment", "letter", "Лист-повідомлення СБУ")
                ...
                .HasOptional(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("DomicileChangeRestrictions")
                ...
                .HasOptional(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("PsychophysiologicalResearch")
                        ...
                        .HasOptional("Attachment", "PassingAct", "Акт проходження")
                        .HasOptional("Attachment", "CancelApplication", "Заява про відмову")
                        .AcceptEmbeddedOperations()
                    )
                ...
                .HasOptional(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("FailureToSubmitDocumentsForStateAccess")
                        ...
                        .HasOptional("Attachment", "Protocol", "Повідомлення СРСД або протокол")
                        .AcceptEmbeddedOperations()
                    )
                    .WithFormFieldType("form")
                )
                .HasMultiple(r => r
                    .Target(ctx.CreateBuilder().IsEntity()
                        .WithName("AppealAgainstDecisionsOfSSU")
